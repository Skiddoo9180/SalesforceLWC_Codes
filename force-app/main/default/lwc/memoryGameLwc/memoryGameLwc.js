...
//             if(this.openedCards[0].type===this.openedCards[1].type)
//             {
//                 this.matchedCard=this.matchedCard.concat('this.openedCards[1]','this.openedCards[0]')
//                 this.matched()
//             }
//             else
//             {
...
//     {
//         let cards=this.template.querySelectorAll('.card')
//         Array.from(cards).forEach(items=>{
//             if(action==='ENABLE')
//             {
//                 let isMatch = items.classList.contains('match')
//                 if(!isMatch)
//                 {
...
//         while(counter>0)
//         {
//             let index=Math.floor(Math.randow()*counter)
